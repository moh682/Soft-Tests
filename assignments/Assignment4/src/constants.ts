...
if (process.env.ENV === 'TEST') {
	SERVER_PORT = 4000;
	MYSQL_USERNAME = process.env.TEST_MYSQL_USERNAME || MYSQL_USERNAME;
	MYSQL_PASSWORD = process.env.TEST_MYSQL_PASSWORD || MYSQL_PASSWORD;
	MYSQL_DATABASE = process.env.DATABASE || MYSQL_DATABASE
}
